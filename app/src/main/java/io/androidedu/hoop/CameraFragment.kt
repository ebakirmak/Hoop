...
class CameraFragment : Fragment(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        listener?.onFragmentInteraction("Fragment butona tıkladım")
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(photoName: String, photoCount: Int) =
            CameraFragment().apply {
                arguments = Bundle().apply {
                    putString(ARG_PARAM1, photoName)
                    putInt(ARG_PARAM2, photoCount)
                }
            }
    }
}
